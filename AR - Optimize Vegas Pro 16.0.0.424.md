...
كتبت: 2025/11/19
آخر تعديل كان: 2025/2/28

# التثبيت و التزبيط

## dlls
انسخ هذه الـ[dlls](vegas%20dlls%20pack.7z) بعد تثبيتك لـVegas 16.

انسخهم لنفس **جذر** Vegas pro, بالتحديد:
...
- أي dll خارج مجلد 64bit فهو 32bit.
...
## هذه الملاحظة مضمنه مسبقا في خانه [[#dlls]]، رجاء اتجه هناك
عموما، كل ما يكتب هنا هو لغرض الحفظ لمن أراد أن يقرأ.
